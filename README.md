...
### **OSINT Enthusiast   Python Developer | Open-Source Contributor**

🔍 **Passionate about**: Open-Source Intelligence (OSINT), Web Scraping, and Automating Investigations.
💻 **Currently Building**: [Gateway-Lookup Tool](link-to-repo) – Detect payment gateways, Cloudflare, and CAPTCHA on any domain.
📚 **Learning**: Advanced Python, Reverse Engineering, and Ethical Hacking.
